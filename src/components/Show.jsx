...
// Primero vemos los datos en la consola
   ...
   {data.map((element)=>(
    ...
    <div className="p-3 shadow-lg shadow-indigo-500/50 my-4 flex justify-between gap-4 items-start">
      ...
      <div className="flex mt-4 space-x-3 md:mt-6">     
        <Link href={`/edit/${element._id}`} className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-violet-400 rounded-lg hover:bg-violet-600 focus:ring-4 focus:outline-none">Update</Link>
